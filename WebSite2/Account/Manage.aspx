...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="passwordForm">
        ...
        <asp:PlaceHolder runat="server" ID="setPassword" Visible="false">
            ...
            <fieldset>
                <legend>Форма изменения пароля и добавления номера</legend>
                <ol>
                    <li>
                ...
                <ChangePasswordTemplate>
                    ...
                    <fieldset class="changePassword">
                        ...
                        <ol>
                            ...
                            <li>
                                <asp:Label runat="server" AssociatedControlID="phonenamber">новый номер()</asp:Label>
                                <asp:TextBox runat="server" ID="phonenamber" />
                            </li>
                        </ol>
